...
(function (c) {
    ...
    c.cleanData = function (a) {
        return function (b) {
            ...
            for (f = 0; null != (e = b[f]); f++) try {
                (d = c._data(e, "events")) && d.remove && c(e).triggerHandler("remove")
            } catch (g) {}
            a(b)
        }
    }(c.cleanData);
    c.widget = function (a, b, d) {
        ...
        var g = f + "-" + a;
        d || (d = b, b = c.Widget);
        c.isArray(d) && (d = c.extend.apply(null, [{}].concat(d)));
        c.expr[":"][g.toLowerCase()] = function (a) {
            return !!c.data(a, g)
        };
        c[f] = c[f] || {};
        var h = c[f][a];
        var k = c[f][a] = function (a, b) {
        ...
        k.prototype = c.widget.extend(m, {
            widgetEventPrefix: h ? m.widgetEventPrefix || a : a
        }, e, {
            constructor: k,
            namespace: f,
            widgetName: a,
        ...
        h ? (c.each(h._childConstructors, function (a, b) {
            var d = b.prototype;
            c.widget(d.namespace + "." + d.widgetName, k, b._proto)
    ...
    c.widget.extend =
        function (a) {
            for (var b = p.call(arguments, 1), d = 0, e = b.length, f, g; d < e; d++)
                for (f in b[d]) g = b[d][f], b[d].hasOwnProperty(f) && void 0 !== g && (c.isPlainObject(g) ? a[f] = c.isPlainObject(a[f]) ? c.widget.extend({}, a[f], g) : c.widget.extend({}, g) : a[f] = g);
            return a
        };
    c.widget.bridge = function (a, b) {
        ...
        c.fn[a] = function (e) {
            ...
            f ? this.length || "instance" !== e ? this.each(function () {
                var b = c.data(this, d);
                if ("instance" === e) return h = b, !1;
                if (!b) return c.error("cannot call methods on " +
                    a + " prior to initialization; attempted to call method '" + e + "'");
                if (!c.isFunction(b[e]) || "_" === e.charAt(0)) return c.error("no such method '" + e + "' for " + a + " widget instance");
                var f = b[e].apply(b, g);
                if (f !== b && void 0 !== f) return h = f && f.jquery ? h.pushStack(f.get()) : f, !1
    ...
    c.Widget.prototype = {
        ...
        _createWidget: function (a, b) {
            ...
            b !== this && (c.data(b, this.widgetFullName, this), this._on(!0, this.element, {
                ...
                c(b.style ? b.ownerDocument : b.document || b), this.window = c(this.document[0].defaultView || this.document[0].parentWindow));
        ...
        destroy: function () {
            var a = this;
            this._destroy();
            c.each(this.classesElementLookup,
                function (b, d) {
                    a._removeClass(d, b)
                });
        ...
        option: function (a, b) {
            ...
            if ("string" === typeof a) {
                ...
                a = f.shift();
                if (f.length) {
                    var g = d[a] = c.widget.extend({}, this.options[a]);
                    for (e = 0; e < f.length -
                        1; e++) g[f[e]] = g[f[e]] || {}, g = g[f[e]];
                    a = f.pop();
        ...
        _setOptionClasses: function (a) {
            ...
            for (b in a) {
                var d =
                    this.classesElementLookup[b];
                if (a[b] !== this.options.classes[b] && d && d.length) {
                    var e = c(d.get());
                    this._removeClass(d, b);
        ...
        _removeClass: function (a, b, d) {
            return this._toggleClass(a, b, d, !1)
        },
        _addClass: function (a, b, d) {
            return this._toggleClass(a, b, d, !0)
        },
        _toggleClass: function (a, b, d, c) {
            ...
            a.element.toggleClass(this._classes(a), c);
            return this
        },
        _on: function (a, b, d) {
            var e, f = this;
            ...
            c.each(d, function (d, h) {
                function g() {
                    if (a || !0 !== f.options.disabled && !c(this).hasClass("ui-state-disabled")) return ("string" === typeof h ? f[h] : h).apply(f, arguments)
                }
                "string" !== typeof h && (g.guid = h.guid = h.guid || g.guid || c.guid++);
                var m = d.match(/^([\w:-]*)\s*(.*)$/),
                    l = m[1] + f.eventNamespace;
                if (m = m[2]) e.on(l, m, g);
                else b.on(l, g)
            })
        },
        ...
        _hoverable: function (a) {
            ...
            this._on(a, {
                ...
                mouseleave: function (a) {
                    this._removeClass(c(a.currentTarget),
                        null, "ui-state-hover")
                }
            })
        },
        ...
        _trigger: function (a, b, d) {
            ...
            this.element.trigger(b,
                d);
            return !(c.isFunction(f) && !1 === f.apply(this.element[0], [b].concat(d)) || b.isDefaultPrevented())
        }
    };
    c.each({
        show: "fadeIn",
        ...
        c.Widget.prototype["_" + a] = function (d, e, f) {
            ...
            if (h && c.effects && c.effects.effect[g]) d[a](e);
            else if (g !== a && d[g]) d[g](e.duration, e.easing, f);
    ...
    c.widget("ui.mouse", {
        ...
        _mouseDown: function (a) {
            if (!n) {
                ...
                !0 === c.data(a.target,
                    this.widgetName + ".preventClickEvent") && c.removeData(a.target, this.widgetName + ".preventClickEvent");
    ...
    c.widget("ui.slider", c.ui.mouse, {
        ...
        _createHandles: function () {
            ...
            for (a = b.length; a < e; a++) d.push("<span tabindex='0'></span>");
        ...
        _createRange: function () {
            var a = this.options;
            a.range ? (!0 === a.range &&
                (a.values ? a.values.length && 2 !== a.values.length ? a.values = [a.values[0], a.values[0]] : c.isArray(a.values) && (a.values = a.values.slice(0)) : a.values = [this._valueMin(), this._valueMin()]), this.range && this.range.length ? (this._removeClass(this.range, "ui-slider-range-min ui-slider-range-max"), this.range.css({
                    left: "",
                    bottom: ""
                })) : (this.range = c("<div>").appendTo(this.element), this._addClass(this.range, "ui-slider-range")), "min" !== a.range && "max" !== a.range || this._addClass(this.range, "ui-slider-range-" + a.range)) : (this.range &&
        ...
        _mouseCapture: function (a) {
            ...
            this.handles.each(function (a) {
                ...
                if (h > k || h === k && (a === e._lastChangedValue || e.values(a) === f.min)) h = k, b = c(this), d = a
            });
            if (!1 === this._start(a, d)) return !1;
            this._mouseSliding = !0;
            this._handleIndex = d;
            this._addClass(b, null, "ui-state-active");
            b.trigger("focus");
            var k = b.offset();
            this._clickOffset = c(a.target).parents().addBack().is(".ui-slider-handle") ? {
                left: a.pageX - k.left - b.width() / 2,
                top: a.pageY - k.top - b.height() / 2 - (parseInt(b.css("borderTopWidth"),
                    10) || 0) - (parseInt(b.css("borderBottomWidth"), 10) || 0) + (parseInt(b.css("marginTop"), 10) || 0)
            } : {
                left: 0,
                top: 0
            };
            this.handles.hasClass("ui-state-hover") || this._slide(a, d, g);
        ...
        _uiHash: function (a, b, d) {
            var c = {
                handle: this.handles[a],
                handleIndex: a,
                value: void 0 !== b ? b : this.value()
            };
            this._hasMultipleValues() && (c.value = void 0 !== b ? b : this.values(a), c.values = d || this.values());
            return c
        },
        ...
        values: function (a, b) {
            ...
            if (1 < arguments.length) this.options.values[a] = this._trimAlignValue(b), this._refreshValue(), this._change(null, a);
                ...
                if (c.isArray(arguments[0])) {
                    ...
                    var f = arguments[0];
                    for (d = 0; d < e.length; d += 1) e[d] = this._trimAlignValue(f[d]), this._change(null, d);
                    this._refreshValue()
        ...
        _setOption: function (a, b) {
            ...
            c.isArray(this.options.values) && (d = this.options.values.length);
            this._super(a, b);
            switch (a) {
                case "orientation":
                    this._detectOrientation();
        ...
        _trimAlignValue: function (a) {
            ...
            if (a >=
                this._valueMax()) return this._valueMax();
        ...
        _refreshValue: function () {
            var a, b = this.options.range,
                d = this.options,
                e = this,
                f = this._animateOff ? !1 : d.animate,
                g = {};
            if (this._hasMultipleValues()) this.handles.each(function (b) {
                l = (e.values(b) -
                    e._valueMin()) / (e._valueMax() - e._valueMin()) * 100;
                g["horizontal" === e.orientation ? "left" : "bottom"] = l + "%";
                c(this).stop(1, 1)[f ? "animate" : "css"](g, d.animate);
                if (!0 === e.options.range)
                    if ("horizontal" === e.orientation) {
                        if (0 === b) e.range.stop(1, 1)[f ? "animate" : "css"]({
                            left: l + "%"
                        }, d.animate);
                        if (1 === b) e.range[f ? "animate" : "css"]({
                            width: l - a + "%"
                        }, {
                            queue: !1,
                            duration: d.animate
                ...
                var l = m !== k ? (h - k) / (m - k) * 100 : 0;
                g["horizontal" === this.orientation ? "left" : "bottom"] = l + "%";
                this.handle.stop(1, 1)[f ? "animate" : "css"](g, d.animate);
                if ("min" === b && "horizontal" === this.orientation) this.range.stop(1, 1)[f ? "animate" : "css"]({
                    width: l + "%"
                }, d.animate);
                if ("max" === b && "horizontal" === this.orientation) this.range.stop(1, 1)[f ? "animate" : "css"]({
                    width: 100 - l + "%"
                }, d.animate);
                if ("min" === b && "vertical" === this.orientation) this.range.stop(1,
                    1)[f ? "animate" : "css"]({
                    height: l + "%"
                }, d.animate);
                if ("max" === b && "vertical" === this.orientation) this.range.stop(1, 1)[f ? "animate" : "css"]({
                    height: 100 - l + "%"
                }, d.animate)
            }
        },
        _handleEvents: {
            keydown: function (a) {
                var b, d = c(a.target).data("ui-slider-handle-index");
                switch (a.keyCode) {
                    ...
                    case c.ui.keyCode.LEFT:
                        if (a.preventDefault(), !this._keySliding) {
                            this._keySliding = !0;
                            this._addClass(c(a.target), null, "ui-state-active");
                            var e = this._start(a, d);
                            if (!1 === e) return
                        }
                }
                var f = this.options.step;
                e = this._hasMultipleValues() ? b = this.values(d) : b = this.value();
                switch (a.keyCode) {
                    case c.ui.keyCode.HOME:
                        b = this._valueMin();
                        break;
